    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="{{ asset('/designAdmin/images/logo.png') }}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{ asset('/designAdmin/images/logo2.png') }}"
                        alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>These</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Sujet</a>
                            </li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">étudiant</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="font-themify.html">date</a></li>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">pdf</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-bar-chart"></i>Stage</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="charts-chartjs.html">Sujet</a></li>
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="charts-flot.html">etudiant</a></li>
                            <li><i class="menu-icon fa fa-pie-chart"></i><a href="charts-peity.html">date</a></li>
                            <li><i class="menu-icon fa fa-pie-chart"></i><a href="charts-peity.html">pdf</a></li>
                        </ul>
                    </li>
            ...
            <div class="header-menu">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media bg-flat-color-1" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('/designAdmin/images/avatar/1.jpg') }}"></span>
                                ...
                                <a class="dropdown-item media bg-flat-color-4" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('/designAdmin/images/avatar/2.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-5" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('/designAdmin/images/avatar/3.jpg') }}"></span>
                                    <span class="message media-body">
                                ...
                                <a class="dropdown-item media bg-flat-color-3" href="#">
                                    <span class="photo media-left"><img alt="avatar"
                                            src="{{ asset('/designAdmin/images/avatar/4.jpg') }}"></span>
                                    <span class="message media-body">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('/designAdmin/images/admin.jpg') }}"
                                alt="User Avatar">
                        </a>
